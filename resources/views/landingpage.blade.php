...
<body class="antialiased text-zinc-800 bg-white">
    <header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-zinc-200">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="/login" class="px-3 py-1.5 rounded-full text-sm border border-zinc-300 hover:bg-zinc-50">Log
                    in</a>
                <a href="#contact" class="px-4 py-1.5 rounded-full text-sm bg-zinc-900 text-white hover:bg-zinc-800">Get
                    Started</a>
            </div>
        </div>
    </header>
    ...
    <main>
        <section class="relative">
            <div id="home"
                class="mx-auto max-w-7xl px-4 sm:px-6 pt-14 pb-16 grid lg:grid-cols-2 gap-10 items-center">
                <div class="space-y-6">
                    <div
                        class="inline-flex items-center gap-2 rounded-full border border-zinc-200 px-3 py-1 text-xs text-zinc-600">
                    ...
                    <p class="text-zinc-600 max-w-xl">
                        Real-time monitoring for pellet-shredding performance with RPM, load, power, and cost
                        graphs—Pelcutron keeps your machine efficient and reliable.


                    </p>
                    <div class="flex flex-wrap gap-3">
                        <a href="#order"><button
                                class="px-5 py-2 rounded-full bg-zinc-900 text-white hover:bg-zinc-800 text-sm">Order
                                Now!</button></a>
                        <a href="#features"><button
                                class="px-5 py-2 rounded-full border border-zinc-300 hover:bg-zinc-50 text-sm">Learn
                                More</button></a>
                    </div>
                ...
                <div class="relative">
                    <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                        <img src="/image/peternak-ayam.png" alt="Shrimp illustration"
                            class="w-full h-full object-cover object-center max-h-[560px] mx-auto">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="features" class="py-10 sm:py-16">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center">
                <div class="aspect-[16/10] rounded-2xl overflow-hidden shadow-lg">
                    <img src="{{ url('/image/alat.jpeg') }}" alt="Shrimp illustration"
                        class="w-full h-full object-cover object-center max-h-[560px] mx-auto">
                </div>
                <div>
                    <h2 class="text-3xl sm:text-4xl font-semibold leading-tight">
                        Digitilize Poultry Feed Processing<span class="text-zinc-500 font-normal">Through
                            Innovation</span>
                    </h2>
                    <p class="text-zinc-600 mt-4">Designed to enhance efficiency and precision, Pelcutron provides
                        real-time insights that help optimize every stage of pellet shredding.</p>
                </div>
            </div>
                ...
                <div class="rounded-2xl border border-zinc-200 p-6 sm:p-8 bg-white/60">
                    <div class="grid sm:grid-cols-3 gap-8">
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-zinc-600">Monitor machine performance with integrated sensors and
                                automate routine checks to save time.</p>
                        </div>
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-zinc-600">Track RPM, load, power usage, and output weight through
                                clear, real-time dashboard graphs.</p>
                        </div>
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-zinc-600">Analyze trends to maintain machine stability and ensure
                                consistent pellet quality.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="boat" class="py-10 sm:py-16 bg-zinc-50">
            <div class="mx-auto max-w-7xl px-4 sm:px-6">
                <h2 class="text-2xl sm:text-3xl font-semibold mb-6 text-center md:text-left">IoT-Based Monitoring
                    System</h2>
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="aspect-[4/3] aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
                        <img src="{{ url('/image/alat.jpeg') }}" alt="Aquaculture technician"
        ...
        <section id="order" class="py-12 sm:py-16 bg-zinc-50">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    <h3 class="text-2xl sm:text-3xl font-semibold">Order Now <span
                            class="text-zinc-500 font-normal">Your Pelcutron System</span></h3>
                    <p class="text-zinc-600 mt-3">Bring automation and data-driven control to your feed processing.</p>
                    <div class="mt-6">
                        <a href="https://wa.me/6285694014009"><button
                                class="px-5 py-2 rounded-full bg-zinc-900 text-white hover:bg-zinc-800 text-sm">Contact
                                Sales</button></a>
                    </div>
                </div>
            </div>
